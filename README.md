...
The concept in one picture — a student studying offline, the on-device engine behind the app, and the governed pipeline study material must pass before it ships:

![Prepnest concept diagram — Student, Prepnest Mobile App, On-Device Engine, and the Governed Content Pipeline](diagrams/prepnest-concept.svg)

<sub>Beginner-friendly overview. The [Architecture](#architecture) diagram below is the more technical view. PNG fallback: [`diagrams/prepnest-concept.png`](diagrams/prepnest-concept.png)</sub>
